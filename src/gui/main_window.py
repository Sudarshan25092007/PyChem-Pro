...
from .mol_viewer_3d import MolViewer3D
from .mol_viewer_2d import MolViewer2D
...
class ConversionWorker(QObject):
    ...
    def run(self):
        try:
            ...
            from ..geometry import generate_3d_coordinates
            generate_3d_coordinates(mol, optimize=True, max_opt_steps=300)
            self.progress.emit(70)

            # Compute charges
            from ..charges import compute_gasteiger_charges
...
class MainWindow(QMainWindow):
    ...
    def _optimize_geometry(self):
        ...
        try:
            from ..geometry.optimizer import optimize_geometry
    ...
    def _import_structure_file(self):
        ...
        try:
            from ..io import read_mol, read_sdf, read_mol2, read_pdb
