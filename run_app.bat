...
set "SEARCH_PATHS=E:\D-Drive\Portable_Python_3.10.5_x64\App\Python\python.exe;E:\Portable_Python_3.10.5_x64\App\Python\python.exe;D:\Portable_Python_3.10.5_x64\App\Python\python.exe;E:\Vijay\Portable_Python_3.10.5_x64\App\Python\python.exe;C:\Python310\python.exe"
